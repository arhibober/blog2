...
define( 'WPCACHEHOME', '/hosting/kostinac/data/www/kostina-cassanelli.kh.ua/wp-content/plugins/wp-super-cache/' );
define('DB_NAME', 'cassanelli');

/** Имя пользователя MySQL */
define('DB_USER', 'cassanelli');

/** Пароль к базе данных MySQL */
define('DB_PASSWORD', 'Rjytw*Ctpjyf18');
